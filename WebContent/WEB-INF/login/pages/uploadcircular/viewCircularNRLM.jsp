...
function popitup(fileName) {
     ...
     var path="FileFolder/UpLoadCircular/NRLM/"+fileName;
   //  alert(path);
...
function fileUpload(fileName){
   ...
   // alert("schemeName=="+schemeName+"-filename-"+fileName);
	...
	document.forms[0].action="uploadCircular.do?method=downloadCircular&schemeName=NRLM&path="+fileName;
...
<body onclick="checkChildWindow()">
	<html:form action="login/uploadCircular" method="post"
		enctype="multipart/form-data">
		<div class="mainpane">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td class="actionstxt" width="100%" align="center">NRLM
