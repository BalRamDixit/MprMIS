...
function save(){
	...
	if(status==true){
		document.forms[0].action="monitorFirstInstallment.do?methodName=save3"+"&"+tokenParameter+"="+tokenValue;
...
function isNumberKey(evt)
{
   ...
   return true;
    ...
    function checkAmount(vv,idForCheck){
     ...
     var val1=$("#"+vv).val();
     var tfp=parseInt(abc) * .15;
     var ss=val1.replace(/,/g , "");
    // alert("----"+ss+"-----------"+tfp); 
      if(parseInt(ss)>parseInt(tfp)){
	       alert("Value should be Less than 15% of the Project Cost  ");
	       $("#"+vv).val("0");
...
<html:form action="login/monitorFirstInstallment">
			...
			<tr>
					<td align="center" class="pageHeader">Third Installment</td>					
                </tr>
			</table>
			<table width="100%" >
			    <tr>
	               	<td>
		 				 ...
		 				 <a onclick="third()"class="tablinks active">Third Installment</a>
			...
			<div style="overflow-x:scroll;overflow-y:hidden;">
			 ...
			 <tr>
                 ...
                 <th align="center">Date Issuance of E4<span class="text-error">*</span></th>
			...
			<logic:iterate id="mm" name="mm" indexId="index" scope="request">
				...
				<tr>                               
					...
					<td align="center"><span class="text-error"><html:text property="dateofIssuance"  readonly="true" onchange="checkAllDates('${index}')" styleId="d1${index}" styleClass="datepicker input" value='${mm.dateofIssuance}' />  </span></td> 
					<td align="center"><span class="text-error"><html:text property="dateofRecommend" readonly="true" onchange="checkAllDates('${index}')" styleId="d2${index}" styleClass="datepicker input" value='${mm.dateofRecommend}' />  </span></td> 
					<td align="center"><span class="text-error"><html:text property="dateofReceipt"   readonly="true" onchange="checkAllDates('${index}')"   styleId="d3${index}" styleClass="datepicker input" value='${mm.dateofReceipt}' />  </span></td> 
					...
					<td align="center"><span class="text-error"><html:text styleClass="datepicker input" readonly="true" property="relDate"  onchange="checkAllDates('${index}')" styleId="d4${index}" value='${mm.relDate }' /><input type='hidden' value="${mm.reldateHidden}"></span></td>
					...
					<td align="center"><span class="text-error"><html:text styleClass="input" onkeyup="checkUtilizationPercent(this);" onkeypress="return isNumberKey(event)" property="utilizationPercent" value='${mm.utilizationPercent}' />  </span></td> 
