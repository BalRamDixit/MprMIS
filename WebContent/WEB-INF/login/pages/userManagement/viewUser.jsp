...
{ 
	...
	if(type=='ZP' || type=='BP'){
	 ...
	 document.forms[0].action = "userAction.do?methodName=getDataList&form=4&type="+type+"&"+tokenParameter+"="+tokenValue+"&param="+param;
...
function searchUser(form){
    ...
    var status= true;
	if(status==true){
	document.userForm.action = "userAction.do?methodName=getDataList&form=4&"+tokenParameter+"="+tokenValue;
...
<html:form action="login/userAction">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="center" class="actionstxt"><span class="actionstxt"><bean:message key="lable.view"/></span>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr >
					<td><bean:message key="lable.user.levelofuser"/><span class="mandatory">*</span></td>
					<td>
					<html:select property="levelCode" styleId="levelCode" onchange="getUsers('1',this);getDataList(this.value,'0','0')">
				...
				<tr>
					<td><bean:message key="lable.user.selectState"/><span class="mandatory">*</span></td>
					<td>
			  ...
			  <logic:present name="district">
				...
				<tr>
					<td><bean:message key="lable.user.selectDistrict"/><span class="mandatory">*</span></td>
					<td>
			 ...
			 <logic:present name="block">
				...
				<tr>
					<td><bean:message key="lable.user.selectBlockPanchayat"/><span class="mandatory">*</span></td>
					<td>
				...
				<tr>
					<td><bean:message key="lable.user.loginID"/><span class="mandatory">*</span></td>
			...
			<logic:equal name="searchSuccess" value="searchSuccess">
				<table id="roleListRow" class="" width="100%" border="0" align="center" cellpadding="0"cellspacing="0">
					...
					<tr>
					<td><bean:message key="lable.user.userName"/><span class="mandatory">*</span></td>
					<td><html:text property="userName" onblur="this.value=this.value.toUpperCase();"/></td>
					</tr>
					
					<tr>
						<td><bean:message key="lable.user.designation"/><span class="mandatory">*</span></td>
						<td><html:text property="userDesignation" onblur="this.value=this.value.toUpperCase();"/></td>
					</tr>
					
					<tr>
					<td><bean:message key="lable.user.emailID"/><span class="mandatory"></span></td>
					<td><html:text property="emailId" onblur="this.value=this.value.toUpperCase(),echeck(this.value);"/></td>
					</tr>
					
					<tr>
						<td><bean:message key="lable.user.accountStatus"/></td>
			...
			<logic:equal name="searchSuccess" value="<%=Constants.SEARCH_SUCCESS_OPEN%>">
				<table id="roleListRow" class="" width="100%" border="0" align="center" cellpadding="0"cellspacing="0">
					...
					<tr>
					<td><bean:message key="lable.user.designation"/><span class="mandatory">*</span></td>
					<td><html:text property="userDesignation" readonly="true"/></td>
					</tr>
					
					<tr>
					<td><bean:message key="lable.user.emailID"/><span class="mandatory"></span></td>
					<td><html:text property="emailId" readonly="true"/></td>
					</tr>
