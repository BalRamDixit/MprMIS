...
var tokenValue= '<%=request.getSession().getAttribute("TRACKERID")%>';
	...
	{
		document.forms[0].action = "trainingDurationAction.do?methodName=showDropDown";
		document.forms[0].submit();
	}
	function filterDropDown1() 
	{
		document.forms[0].action = "trainingDurationAction.do?methodName=showDropDown1";
		document.forms[0].submit();
	}
	function filterDropDown2()
	{
		document.forms[0].action = "trainingDurationAction.do?methodName=showDropDown2";
		document.forms[0].submit();
	}
	function filterDropDown3()
	{
		document.forms[0].action = "trainingDurationAction.do?methodName=showDropDown3";
		document.forms[0].submit();
	}
	function showData()
	{
		document.forms[0].action = "trainingDurationAction.do?methodName=showPage&"
				+ tokenParameter + "=" + tokenValue;
		document.forms[0].submit();
	}
	...
	function resetFilters() 
	{
		...
		document.forms[0].action = "trainingDurationAction.do?methodName=resetFilters&"
		document.forms[0].submit();
	}
</script>
<html:form action="/trainingDurationAction">
	<table width="100%" align="center">
		<tr>
			<td align="center" class="pageHeader">Report Of Training Duration</td>
		</tr>
		...
		<tr>
			...
			<div style="width: 940px; height: 450px; overflow: auto;">
				<table class="borderedPresentation" width="100%">
					...
					<logic:present name="trainingDurationLst">
						<logic:iterate id="list" name="trainingDurationLst"
							indexId="index">
							<tr>
								<td>${index + 1}</td>
								<td>${list[1]}</td>
