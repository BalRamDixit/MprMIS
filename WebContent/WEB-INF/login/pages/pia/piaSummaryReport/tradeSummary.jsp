...
<script>
	...
	function filterDropDown() {
		document.forms[0].action = "tradeSummaryAction.do?methodName=showDropDown";
		document.forms[0].submit();
	}
	function filterDropDown1() {
		document.forms[0].action = "tradeSummaryAction.do?methodName=showDropDown1";
		document.forms[0].submit();
	}
	function filterDropDown2() {
		document.forms[0].action = "tradeSummaryAction.do?methodName=showDropDown2";
		document.forms[0].submit();
	}
	function filterDropDown3() {
		document.forms[0].action = "tradeSummaryAction.do?methodName=showDropDown3";
		document.forms[0].submit();
	}

	function showData() {
		document.forms[0].action = "tradeSummaryAction.do?methodName=showPage&"
				+ tokenParameter + "=" + tokenValue;
		document.forms[0].submit();
	}
	function resetFilters() {
		...
		document.forms[0].action = "tradeSummaryAction.do?methodName=resetFilters&"
		document.forms[0].submit();
	}
</script>
<html:form action="/tradeSummaryAction">
	<table width="100%" align="center">

		<tr>
			<td align="center" class="pageHeader">Report Of Trade Wise PIA</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<div style="width: 940px; height: 450px; overflow: auto;">
				<table class="borderedPresentation" width="100%">
					...
					<logic:present name="trainingSummaryLst">
						<logic:iterate id="list" name="trainingSummaryLst" indexId="index">
							<tr>
								<td>${index + 1}</td>
								<td>${list[1]}</td>
								<td>${list[2]}</td>
