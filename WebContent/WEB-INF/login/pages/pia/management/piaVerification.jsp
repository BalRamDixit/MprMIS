...
function showData() {
	document.forms[0].action = "verifyPiaAction.do?methodName=getPiaDetail&page=verify&" + tokenParameter + "=" + tokenValue;
...
function verify(){
	if(validate()){
		var status = window.confirm("Do You want to verify this Applicant Organisation");
		if(status){
			document.forms[0].action = "verifyPiaAction.do?methodName=confirmPia&" + tokenParameter + "=" + tokenValue;
			document.forms[0].submit();	
		}
	}
}
...
<table width="100%" align="center" style="padding-down: 7px;" class="piaLogTbl">
	...
	<logic:empty name="piaList">
		<td><label class="label-info">NO NEW REGISTRATION OF APPLICANT ORGANISATION IS FOUND FOR VERIFICATION IN OUR DATA BASE</label></td>
	</logic:empty>
	<logic:notEmpty name="piaList">
	<th width="50%"><label class="label-info">Applicant Organisation List for Verification</label></th>
	<td align="center">
...
<tr style="padding-top: 7px;">
	<td width="40%" >Download Applicant Organisation </td>
...
<tr>						
	<th>Applicant Organisation Name</th>
	<td colspan="5"><bean:write name="piaDetail" property="piaName"/></td>
</tr>
<tr>
	<td colspan="5" style="padding-top: 7px;"><label class="label-inverse">NITI Aayog Registration Details:</label></td>
</tr>
<tr>
	<th>NITI Aayog allotted Unique Id:</th>
	<td>
...
<tr>
	<td colspan="5" style="padding-top: 7px;"><label class="label-inverse">Address and Contact Detail</label></td>
</tr>
<tr>
	<th>Address</th>
	<td colspan="4"><bean:write name="piaDetail" property="address"/></td>
</tr>
<tr>
	<th>Pin</th>
	<td colspan="4"><bean:write name="piaDetail" property="pin"/></td>
</tr>
<tr>
	<th>State</th>
	<td colspan="4"><bean:write name="piaDetail" property="stateName"/></td>	
</tr>	
<tr>
	<th>District</th>
	<td colspan="4"><bean:write name="piaDetail" property="districtName"/></td>
</tr>	
<tr>
	<th>Block</th>
	<td colspan="4"><bean:write name="piaDetail" property="blockName"/></td>	
</tr>					
<tr>
...
<tr>
	<th>Email:</th><td colspan="4"><bean:write name="piaDetail" property="email"/></td>
</tr>					
<tr>
	<th>Website: </th><td colspan="4"><bean:write name="piaDetail" property="website"/></td>
</tr>
<tr>	
	<th>OfficePhoto:</th>
...
<tr>
	...
	<td><bean:write name="piaDetail" property="registrationStateName"/></td>
...
<table width="100%" align="center" class="inputTBL" style="padding-top: 7px;">
<c:if test="${piaDetail.l1Remark != null}">
<tr>
<th>Remark from L1:</th>
<td><div class="warning"><bean:write name="piaDetail" property="l1Remark"/></div></td>
</tr>
</c:if> 
<tr>
<th width="30%">Applicant Organisation Application Status</th>
	<td>
		<html:select property="piaApplicationStatus" styleId="piaApplicationStatus" onchange="javascript:showRemark();">
			<html:option value="">Select</html:option>
			<html:option value="V">Verified and found proper </html:option>
			<html:option value="R">Verified and found improper</html:option>	
			<%-- <html:option value="S">Revert back to documents checking</html:option>	 --%>	
		</html:select>
	</td>
</tr>
...
<div align="center" style="padding-top: 15px; padding-bottom: 10px;"> 
	<html:button  styleClass="primaryBtn" property="" onclick="verify()">Submit</html:button>
