package com.infotech.skills.proposal.infrastructure;
...
public class InfrastructureAction extends DispatchAction {
	...
	protected final Log log = LogFactory.getLog(getClass());
	 ...
	 public ActionForward showPage(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	 	throws Exception{
		 log.info("inside show page at InfrastructureAction page");
