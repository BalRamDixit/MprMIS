...
public  class RegistrationForm extends MasterForm{
	...
	private FormFile enrolmentFile;
	...
	public FormFile getEnrolmentFile() {
		return enrolmentFile;
	}
	public void setEnrolmentFile(FormFile enrolmentFile) {
